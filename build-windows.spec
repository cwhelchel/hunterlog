...
# shutil.copyfile('./data/wwbota_continents.json', '{0}/data/wwbota_continents.json'.format(DISTPATH))
# shutil.copyfile('./data/wwff_continents.json', '{0}/data/wwff_continents.json'.format(DISTPATH))